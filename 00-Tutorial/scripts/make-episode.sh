...
#   [RESYNTH=1] bash ~/Projects/spe/00-Tutorial/scripts/make-episode.sh [chapter]
set -uo pipefail
...
BASE=http://127.0.0.1:8000 node "$HERE/drive-firefox.mjs" "$CHAP" 2>&1 | tee /tmp/driver.log || true
