    ...
    public function render(): string
    {
        ...
        $n1 = $this->ctx->nav
            |> (static fn($n) => array_map(static fn($p) => sprintf(
                '<a href="?o=%s"%s title="%s" data-icon="%s"><i data-lucide="%s"></i> %s</a>',
                $p[2], $o === $p[2] ? ' class="active"' : '', $p[1], $p[0], $p[0], $p[1],
            ), $n))
        ...
        <nav class="topnav">
            ...
            <h1><a class="brand" href="/"><i data-lucide="chevron-left"></i> <span>Session PHP Example</span></a></h1>
