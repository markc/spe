...
final class View extends Base
{
    ...
    */
    ...
    private function modalForm(array $data = []): string
    {
        ...
        $action = $id ? "?o=Users&m=update&i=$id" : "?o=Users&m=create";
            ...
            if (deleteModal) {
                ...
                if (confirmBtn) {
                    confirmBtn.addEventListener("click", function() {
                        ...
                        if (postId) {
                            fetch("?o=Users&m=delete&i=" + postId, {
                                method: "POST"
                            })
                            .then(() => {
                                showToast("User deleted successfully", "success");
                                setTimeout(() => {
                                    window.location.href = "?o=Users&m=list";
                                }, 1000);
                            })
        ...
        foreach ($items as $item)
        {
            $html .= '
                <tr>
                    <td>' . $item['id'] . '</td>
                    <td>
                        <a href="?o=Users&m=read&i=' . $item['id'] . '" class="text-decoration-none">' .
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center pt-4 border-top">
                        ...
                        <div>
                            ...
                            <a href="?o=Users&m=list" class="btn btn-secondary me-2">Cancel</a>
