...
abstract class Theme
{
    ...
    protected function authNav(): string
    {
        if (Util::is_usr()) {
            ...
            return "<a href=\"?o=Users&m=profile\"><i data-lucide=\"user\"></i> $name$role</a> <a href=\"?o=Users&m=logout\">Logout</a>";
        }
        return '<a href="?o=Users&m=login"><i data-lucide="lock"></i> Login</a>';
    }
