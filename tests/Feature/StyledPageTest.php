...
describe('Comparison with 01-Simple', function () {
    ...
    test('uses external JS instead of no JS', function () {
        ...
        expect($styledHtml)->toContain('src="/spe.js"');
        expect($simpleHtml)->not->toContain('src="/spe.js"');
    });
