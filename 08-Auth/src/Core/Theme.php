...
final class Theme
{
    ...
    private function isActive(string $href, string $path): bool
    {
        ...
        if (str_starts_with($href, '?o=')) {
            return $this->ctx->in['o'] === substr($href, 3);
        }
        return false;
    }
    ...
    private function authNav(): string
    {
        if (Util::is_usr()) {
            ...
            return "<div class=\"sidebar-divider\"></div><a href=\"?o=Users&m=profile\" data-icon=\"user\"><i data-lucide=\"user\"></i> {$name}{$role}</a><a href=\"?o=Users&m=logout\" data-icon=\"log-out\"><i data-lucide=\"log-out\"></i> Logout</a>";
        }
        return "<div class=\"sidebar-divider\"></div><a href=\"?o=Users&m=login\" data-icon=\"lock\"><i data-lucide=\"lock\"></i> Login</a>";
    }
